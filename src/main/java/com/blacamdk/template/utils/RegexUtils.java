...
public class RegexUtils {
  ...
  /** 密码规则（8位以上, 字母,数字和符号至少包含两项） */
  public static final String PASSWORD_PATTERN = "(?!^\\d+$)(?!^[a-zA-Z]+$)(?!^[_#@]+$).{8,}";
  /** 固号（座机）规则 */
   ...
   * *
   */
  private static final String CHINA_MOVE_PATTERN =
